...
import com.haya.android_no_mori.ui.sample.dialog.SampleDialogsActivity
...
class SampleAppListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.transitionSampleDialogsActivityButton.setOnClickListener {
            val intent = Intent(activity?.application, SampleDialogsActivity::class.java)
            startActivity(intent)
        }
        return binding.root
    }
